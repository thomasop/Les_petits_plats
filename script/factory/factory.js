        ...
        if (ingredient.quantity == undefined) {
            ...
            if (ingredient.unit !== undefined) {
                if (ingredient.unit == 'grammes') {
                    li.textContent = ingredient.ingredient + ": " + ingredient.quantity + "g";
                } else if (ingredient.unit == 'ml'){
                    li.textContent = ingredient.ingredient + ": " + ingredient.quantity + "ml";
                } else if (ingredient.unit == 'cuillères à soupe' || ingredient.unit == 'cuillères à café'){
                    li.textContent = ingredient.ingredient + ": " + ingredient.quantity + " cuillères";
                } else if (ingredient.unit == 'cl'){
                    li.textContent = ingredient.ingredient + ": " + ingredient.quantity + "cl";
                }
            } else {
