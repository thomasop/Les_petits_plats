            ...
            if (type == 'ustensils') {
                var getRecipe = data.data.filter((recipe) => {
                    var getUstensil = recipe.ustensils.filter(ustensil => {
                        return ustensil.toLowerCase().includes(input.value)
                    })
                ...
                var getRecipe = data.data.filter((recipe) => {
                    return recipe.appliance.toLowerCase().includes(input.value)
                })
                ...
                var getRecipe = data.data.filter((recipe) => {
                    var getIngredient = recipe.ingredients.filter(ingredient => {
                        return ingredient.ingredient.toLowerCase().includes(input.value)
                    })
